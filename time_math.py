...
class math_change:
    ...
    def changeNumber_math(self,time_num):
        """
            この関数によって数字は別の形に変わり返されます。
                |-(0)(何も変換をせず、そのまま返す)
                |-(1)(√をとる)
                |-(2)(Logをとる)
                |-(3)(分数の形をとる)
